"""The minimal implementation of multi-layer perceptron. 
...
def train_network(X_train, T_train, X_test, T_test, 
    ...
    return W1, B1, W2, B2, ce_train[1:], acc_train[1:], ce_test[1:], acc_test[1:]
...
def main():
    ...
    parser.add_argument('-hu', '--hidden_units', type=int, default=11,
    ...
    parser.add_argument('-o', '--output-file-path', type=str, 
                        default=time.strftime("bp_v0_%Y%m%d-%H%M%S")+".npz")
    args = parser.parse_args()

    input_path, output_path = args.input_file_path, args.output_file_path
    lr, n_hid, n_epochs = args.learning_rate, args.hidden_units, args.epochs
    n_in, n_out = 28*28, 10
    ...
    # Train
    W1, B1, W2, B2, ce_train_new, acc_train_new, ce_test_new, acc_test_new = \
    ...
    np.savez(output_path, 
             W1=W1, B1=B1, W2=W2, B2=B2, lr=lr, n_hid=n_hid, 
